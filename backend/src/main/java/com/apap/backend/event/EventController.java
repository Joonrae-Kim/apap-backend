...
public class EventController {
    ...
    @GetMapping
    public ApiResponse<List<EventResponse>> list(@RequestParam Long userId) {
        List<EventResponse> events = detectionEventRepository.findAllByScenarioUserIdOrderByDetectedAtDesc(userId)
                .stream()
